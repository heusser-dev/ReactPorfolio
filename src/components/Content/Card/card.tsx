  ...
  return (
    <div className="container z-40 w-11/12 h-auto  ml-auto mr-auto  mb-4 mt-28 bg-white bg-opacity-0 rounded-lg">
      ...
      <div className='container hover:scale-105 transform transition-transform duration-300'>
        ...
        <h1 className="text-3xl font-bold ml-4 mb-2 animate-fade-in-right ">JUAN PABLO HEUSSER
          ESCAMILLA</h1>
      </div>
      <div className="flex flex-wrap px-4 hover:scale-105 transform transition-transform duration-300">
        <div className="w-full md:w-full md:pr-5 mb-5 mr-auto bg-white bg-opacity-80 rounded-lg animate-expand-vertically animate-delay-700">
      ...
      <div className="flex flex-wrap px-4 hover:scale-105 transform transition-transform duration-300">
      <div className="w-full md:w-full md:pr-5 mb-5 mr-auto bg-white bg-opacity-80 rounded-lg ">
          <p className="text-lg mt-2 ml-4">
