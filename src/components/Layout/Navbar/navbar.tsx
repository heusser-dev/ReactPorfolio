...
const Navbar: React.FC = () => {
  return (
    ...
    <nav className="md:w-4/12 w-7/12  mx-auto  border-8 py-2  border-cyan-600 md:mx-auto z-50 rounded-r-3xl rounded-l-3xl dark:border-white dark:bg-sky-950 bg-opacity-100 bg-white dark:text-white text-sky-950 justify-around items-center rounded-b-lg border-x border-y animate-pulse-fade-in">
